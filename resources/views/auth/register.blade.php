...
<head>
  ...
  <link rel="shortcut icon"
      href="{{ asset('frontend/assets/images/icons/favicon.ico') }}" />
</head>
        ...
        <form method="POST" action="{{ route('register') }}">
            @csrf
                ...
                <div class="mt-3">
                    ...
                    <input type="text" class="form-control u-box-shadow-1" type="text" name="name" />
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    ...
                    <input  class="form-control u-box-shadow-1" type="password" name="password" />
                </div>
                <div class="mt-3">
                    <label for="" class="form-label">Confirm Password</label>
                    <input  class="form-control u-box-shadow-1" type="password" name="password_confirmation"/>
                </div>
                <div class="mt-5">
